variable "iso_checksum" {
  type    = string
  default = "sha256:071d5a534c1a2d61d64c6599c47c992c778e08b054daecc2540d57929e4ab1fd"
}
...
variable "iso_url" {
  type    = string
  default = "https://old-releases.ubuntu.com/releases/jammy/ubuntu-22.04.4-desktop-amd64.iso"
}
...
variable "vm_name" {
  type    = string
  default = "ubuntu-22.04-x64-desktop-template"
}
